...
const SpecificGrainInfo = ({ grain }) => {
    ...
    let locationGrown = grain.grownIn.split('+').join(' ')
    ...
    return (
        <section className='grain-info-container'>
            <div className='grain-info-title-image-container'>
                ...
                <img src={ grain.img } alt='image of a brass bowl holding both grain and flour' className='grain-info-img' />
            ...
            <article className='grain-info-card'>
                ...
                <p className='grain-info-detail'>Organic?: <span className='grain-info-bold'>{ organicStatus }</span>, Grown in: <span className='grain-info-bold'>{ locationGrown }</span></p>
